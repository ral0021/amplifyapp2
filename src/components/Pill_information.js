    ...
    <div class="container-fluid text-center mt-5">
        ...
        <div class="row justify-content-center pb-5">
            <div class="col-xl-2 col-lg-3 col-12">
                <button class="menu-button btn btn-light my-2" onclick="window.location.href='./dispense_schedule.html'">Dispense Schedule</button>
            </div>
            <div class="col-xl-2 col-lg-3 col-12">
                <button class="menu-button btn btn-light my-2" onclick="window.location.href='./current_medication.html'">Current Medication</button>
            </div>
            <div class="col-xl-2 col-lg-3 col-12">
                <button class="menu-button btn btn-light my-2" onclick="window.location.href='./add_medication.html'">Add Medication</button>
            </div>
            <div class="col-xl-2 col-lg-3 col-12">
